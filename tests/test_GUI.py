...
class TestGui(TKinterTestCase):
    ...
    #     self.root.EndOfTraining.on_train_end = Mock()
    #     self.pump_events()
    #     self.add_layer_flatten(0)
    #     self.pump_events()
    #     self.add_layer_maxPooling(0)
    ...
    #         self.pump_events()
    #         time.sleep(10)
    #     self.root.EndOfTraining.on_train_end.assert_called_once()
    #     for i in range(5):
    #         self.pump_events()
    #         self.root.listbox_builder.select_set(1)
    #         self.pump_events()
    ...
    def test_start_wrong_path(self):
        self.pump_events()
        self.add_layer_dence(0)
        self.pump_events()
        self.add_layer_dence(0)
    ...
    def test_start_impos_path(self):
        self.pump_events()
        self.add_layer_dence(0)
        self.pump_events()
        self.add_layer_dence(0)
        ...
        self.root.path.config(state='normal')
        self.root.path.delete(0, tk.END)
        self.root.path.insert(0, "E:/Politeh")
        self.root.path.config(state='readonly')
        self.pump_events()
        self.root.msgError = Mock()
        self.pump_events()
